...
$productos = array(
		new Producto("batatas fritas", 10, 1),
		new Producto("refri", 22, 2),
		/*
...
$printer->text("so alterar o resto" . "\n");
$printer->text("deu certo" . "\n");
#La fecha también
